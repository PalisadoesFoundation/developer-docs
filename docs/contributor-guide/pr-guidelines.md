...
1. Get familiar with our [AI Usage Policy](./ai.md). It has many good guidelines for your contributions.
...
1. All the pull requests must have code that is properly linted and formatted, so that uniformity across the repository can be ensured.

1. We do not accept "work in progress" draft Pull Requests. ONLY completed and working pull requests and with respective test units will be accepted. They will be closed if submitted. We focus on work that is ready for immediate review.
